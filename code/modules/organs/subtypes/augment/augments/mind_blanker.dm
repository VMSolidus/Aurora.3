...
/obj/item/organ/internal/augment/bioaug/mind_blanker/proc/cancel_power(var/caster, var/cancelled)
	SIGNAL_HANDLER
	*cancelled = TRUE
...
/obj/item/organ/internal/augment/bioaug/mind_blanker_lethal/proc/cancel_power_lethal(var/caster, var/cancelled)
	SIGNAL_HANDLER
	*cancelled = TRUE
	if(isliving(caster))
